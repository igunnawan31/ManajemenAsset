...
namespace qrmanagement.backend.Services{
    public class TicketService{
        ...
        public async Task<bool> CreateTicketWithAssetsAsync(Ticket ticket, IEnumerable<string> assetNumbers)
        {
            int rowsAffectedTicket = await _ticketRepo.AddTicket(ticket);
